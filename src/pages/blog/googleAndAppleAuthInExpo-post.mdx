...
title: "Google and Apple authentication in expo with firebase ⛨"
...
## Firebase authentication coding
...
- Edit package name, set to the name from `app.json` -> expo.android.package,
- Edit SHA-1 fingerprint, in case you enable google signing your application, you should copy this fingerprint from
